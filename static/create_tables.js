...
document.getElementById("create_tier1_metrics_tables").addEventListener("submit", async (e) => {
e.preventDefault()
const tier1_metrics_schema = document.getElementById("tier1_metrics_schema").value
const create_tier1_metrics_tables_response = await fetch(`/api/create_tier1_metrics_tables/?tier1_metrics_schema=${tier1_metrics_schema}`, {
method: 'GET'
})

const create_tier1_metrics_tables_data = await create_tier1_metrics_tables_response.json();

create_notification(create_tier1_metrics_tables_data.message, create_tier1_metrics_tables_data.status)
})
...
document.getElementById("create_tier2_metrics_tables").addEventListener("submit", async (e) => {
e.preventDefault()
const tier2_metrics_schema = document.getElementById("tier2_metrics_schema").value
const create_tier2_metrics_tables_response = await fetch(`/api/create_tier2_metrics_tables/?tier2_metrics_schema=${tier2_metrics_schema}`, {
method: 'GET'
})

const create_tier2_metrics_tables_data = await create_tier2_metrics_tables_response.json();

create_notification(create_tier2_metrics_tables_data.message, create_tier2_metrics_tables_data.status)
})

document.getElementById("create_tier2_inp_view").addEventListener("submit", async (e) => {
e.preventDefault()
const tier2_inp_view_schema = document.getElementById("tier2_inp_view_schema").value
const create_tier2_input_view_response = await fetch(`/api/create_tier2_inp_view/?tier2_inp_view_schema=${tier2_inp_view_schema}`, {
method: 'GET'
})

const create_tier2_input_view_data = await create_tier2_input_view_response.json();

create_notification(create_tier2_input_view_data.message, create_tier2_input_view_data.status)
})

document.getElementById("create_tier3_metrics_tables").addEventListener("submit", async (e) => {
e.preventDefault()
const tier3_metrics_schema = document.getElementById("tier3_metrics_schema").value
const create_tier3_metrics_tables_response = await fetch(`/api/create_tier3_metrics_tables/?tier3_metrics_schema=${tier3_metrics_schema}`, {
method: 'GET'
})

const create_tier3_metrics_tables_data = await create_tier3_metrics_tables_response.json();

create_notification(create_tier3_metrics_tables_data.message, create_tier3_metrics_tables_data.status)
})

document.getElementById("create_tier3_inp_view").addEventListener("submit", async (e) => {
e.preventDefault()
const tier3_inp_view_schema = document.getElementById("tier3_inp_view_schema").value
const create_tier3_input_view_response = await fetch(`/api/create_tier3_inp_view/?tier3_inp_view_schema=${tier3_inp_view_schema}`, {
method: 'GET'
})

const create_tier3_input_view_data = await create_tier3_input_view_response.json();

create_notification(create_tier3_input_view_data.message, create_tier3_input_view_data.status)
})

...
def execute_process_group_using_metadata(process_group_name, start_date = None, end_date = None, payloads = None, process_frequency = None, user_id = None):
...
WHERE
    ...
    try:
        for process_group_metadata in process_group_metadata_rows:
            process_group_logs[process_group_metadata['OUT_PROCESS_NAME']] = execute_process_using_metadata(process_group_metadata['OUT_PROCESS_NAME'], start_date, end_date, payloads[process_group_metadata['OUT_PROCESS_NAME']], process_frequency, user_id)

...
SELECT
    ...
    ,CASE WHEN INNER_SUB.OPENING_BUY_OR_SELL = 'B'
          THEN INNER_SUB.OPENING_TRADE_PRICE_PER_UNIT
          WHEN INNER_SUB.CLOSING_BUY_OR_SELL = 'B'
          THEN INNER_SUB.CLOSING_TRADE_PRICE_PER_UNIT END       AS BUY_PRICE
...
WHERE
    ...
    AND OPEN_TRD.TRADE_DATE  = (SELECT PROC_DATE FROM PROCESSING_DATE WHERE PROC_TYP_CD = 'STOCK_PROC')
) INNER_SUB

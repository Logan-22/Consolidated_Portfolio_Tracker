...
def execute_process_group_using_metadata(process_group_name, start_date = None, end_date = None, payloads = None, process_frequency = None, user_id = None, instrument_ids = None):

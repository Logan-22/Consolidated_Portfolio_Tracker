...
def insert_intitial_log_record(process_name):
    ...
    logs_insert_clause = "INSERT INTO EXECUTION_LOGS (PROCESS_NAME, PROCESS_ID, STATUS, LOG, PAYLOAD_COUNT, INSERTED_COUNT, UPDATED_COUNT, NO_CHANGE_COUNT, SKIPPED_DUE_TO_SCHEMA, START_TS, END_TS) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
    logs_insert_values = [process_name, process_id, 'Started', 'In Progress', None, None, None, None, None, get_current_timestamp(), None ]
